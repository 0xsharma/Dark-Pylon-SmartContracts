...
contract DLONBSC is ERC20, ERC20Detailed, ERC20Mintable, ERC20Burnable {
    constructor() 
    ERC20Detailed('Dark Pylon','DLON', 18 ) ERC20Mintable() ERC20Burnable() public {
        
    }
    
}

// File: bridgeContractBSC.sol
...
contract bridgeContractBSC{
    ...
    function stakedlon(uint _amount) public {
        ...
        dlon.burnFrom(msg.sender,_amount);
        emit dlonIncoming(msg.sender, _amount, block.timestamp);
        
    }
    
    
    function giveDlonToUser(address to, uint _amount) public {
        
        require(msg.sender==owner, "Only Owner!");
        require( _amount>0, "Amount is 0" );
        dlon.mint( to , _amount);
        emit dlonOutgoing(to, _amount, block.timestamp);
